...
PB_BIND(GetSchemaTypeMappingUnderPathResult, GetSchemaTypeMappingUnderPathResult, AUTO)


PB_BIND(GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry, GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry, AUTO)


PB_BIND(SchemaTypes, SchemaTypes, AUTO)
...
PB_BIND(FunctionType, FunctionType, 2)


PB_BIND(Parameter, Parameter, 2)


PB_BIND(IndexSignature, IndexSignature, 2)
