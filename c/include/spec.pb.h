...
/* Message for get schema type mapping response. */
typedef struct _GetSchemaTypeMappingUnderPathResult {
    /* Map of pkg and schema types mappings. */
    pb_callback_t schema_type_mapping;
} GetSchemaTypeMappingUnderPathResult;

typedef struct _SchemaTypes {
    /* List of schema type mappings. */
    pb_callback_t schema_type;
} SchemaTypes;

typedef struct _GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry {
    pb_callback_t key;
    bool has_value;
    SchemaTypes value;
} GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry;
...
typedef struct _IndexSignature {
    /* The optional index signature key name */
    pb_callback_t key_name;
...
#define GetSchemaTypeMappingUnderPathResult_init_default {{{NULL}, NULL}}
#define GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry_init_default {{{NULL}, NULL}, false, SchemaTypes_init_default}
#define SchemaTypes_init_default                 {{{NULL}, NULL}}
#define ValidateCodeArgs_init_default            {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define FunctionType_init_default                {{{NULL}, NULL}, false, KclType_init_default}
#define Parameter_init_default                   {{{NULL}, NULL}, false, KclType_init_default}
#define IndexSignature_init_default              {{{NULL}, NULL}, false, KclType_init_default, false, KclType_init_default, 0}
...
#define GetSchemaTypeMappingUnderPathResult_init_zero {{{NULL}, NULL}}
#define GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry_init_zero {{{NULL}, NULL}, false, SchemaTypes_init_zero}
#define SchemaTypes_init_zero                    {{{NULL}, NULL}}
#define ValidateCodeArgs_init_zero               {{{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}, {{NULL}, NULL}}
...
#define FunctionType_init_zero                   {{{NULL}, NULL}, false, KclType_init_zero}
#define Parameter_init_zero                      {{{NULL}, NULL}, false, KclType_init_zero}
#define IndexSignature_init_zero                 {{{NULL}, NULL}, false, KclType_init_zero, false, KclType_init_zero, 0}
...
#define FormatPathArgs_dry_run_tag               2
...
#define GetSchemaTypeMappingUnderPathResult_schema_type_mapping_tag 1
#define SchemaTypes_schema_type_tag              1
#define GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry_key_tag 1
#define GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry_value_tag 2
...
#define ValidateCodeArgs_external_pkgs_tag       8
...
#define KclType_function_tag                     17
#define KclType_index_signature_tag              18
...
#define FunctionType_params_tag                  1
#define FunctionType_return_ty_tag               2
#define Parameter_name_tag                       1
#define Parameter_ty_tag                         2
#define IndexSignature_key_name_tag              1
#define IndexSignature_key_tag                   2
#define IndexSignature_val_tag                   3
#define IndexSignature_any_other_tag             4
...
#define GetSchemaTypeMappingUnderPathResult_FIELDLIST(X, a) \
X(a, CALLBACK, REPEATED, MESSAGE,  schema_type_mapping,   1)
#define GetSchemaTypeMappingUnderPathResult_CALLBACK pb_default_field_callback
#define GetSchemaTypeMappingUnderPathResult_DEFAULT NULL
#define GetSchemaTypeMappingUnderPathResult_schema_type_mapping_MSGTYPE GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry

#define GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry_FIELDLIST(X, a) \
X(a, CALLBACK, SINGULAR, STRING,   key,               1) \
X(a, STATIC,   OPTIONAL, MESSAGE,  value,             2)
#define GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry_CALLBACK pb_default_field_callback
#define GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry_DEFAULT NULL
#define GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry_value_MSGTYPE SchemaTypes

#define SchemaTypes_FIELDLIST(X, a) \
X(a, CALLBACK, REPEATED, MESSAGE,  schema_type,       1)
#define SchemaTypes_CALLBACK pb_default_field_callback
#define SchemaTypes_DEFAULT NULL
#define SchemaTypes_schema_type_MSGTYPE KclType
...
X(a, CALLBACK, REPEATED, MESSAGE,  external_pkgs,     8)
#define ValidateCodeArgs_CALLBACK pb_default_field_callback
#define ValidateCodeArgs_DEFAULT NULL
#define ValidateCodeArgs_external_pkgs_MSGTYPE ExternalPkg
...
X(a, CALLBACK, OPTIONAL, MESSAGE,  function,         17) \
X(a, CALLBACK, OPTIONAL, MESSAGE,  index_signature,  18)
...
#define KclType_function_MSGTYPE FunctionType
#define KclType_index_signature_MSGTYPE IndexSignature
...
#define FunctionType_FIELDLIST(X, a) \
X(a, CALLBACK, REPEATED, MESSAGE,  params,            1) \
X(a, STATIC,   OPTIONAL, MESSAGE,  return_ty,         2)
#define FunctionType_CALLBACK pb_default_field_callback
#define FunctionType_DEFAULT NULL
#define FunctionType_params_MSGTYPE Parameter
#define FunctionType_return_ty_MSGTYPE KclType

#define Parameter_FIELDLIST(X, a) \
X(a, CALLBACK, SINGULAR, STRING,   name,              1) \
X(a, STATIC,   OPTIONAL, MESSAGE,  ty,                2)
#define Parameter_CALLBACK pb_default_field_callback
#define Parameter_DEFAULT NULL
#define Parameter_ty_MSGTYPE KclType

#define IndexSignature_FIELDLIST(X, a) \
X(a, CALLBACK, OPTIONAL, STRING,   key_name,          1) \
X(a, STATIC,   OPTIONAL, MESSAGE,  key,               2) \
X(a, STATIC,   OPTIONAL, MESSAGE,  val,               3) \
X(a, STATIC,   SINGULAR, BOOL,     any_other,         4)
#define IndexSignature_CALLBACK pb_default_field_callback
#define IndexSignature_DEFAULT NULL
#define IndexSignature_key_MSGTYPE KclType
#define IndexSignature_val_MSGTYPE KclType
...
extern const pb_msgdesc_t GetSchemaTypeMappingUnderPathResult_msg;
extern const pb_msgdesc_t GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry_msg;
extern const pb_msgdesc_t SchemaTypes_msg;
...
extern const pb_msgdesc_t FunctionType_msg;
extern const pb_msgdesc_t Parameter_msg;
extern const pb_msgdesc_t IndexSignature_msg;
...
#define GetSchemaTypeMappingUnderPathResult_fields &GetSchemaTypeMappingUnderPathResult_msg
#define GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry_fields &GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry_msg
#define SchemaTypes_fields &SchemaTypes_msg
...
#define FunctionType_fields &FunctionType_msg
#define Parameter_fields &Parameter_msg
#define IndexSignature_fields &IndexSignature_msg
...
/* GetSchemaTypeMappingUnderPathResult_size depends on runtime parameters */
/* GetSchemaTypeMappingUnderPathResult_SchemaTypeMappingEntry_size depends on runtime parameters */
/* SchemaTypes_size depends on runtime parameters */
...
/* FunctionType_size depends on runtime parameters */
/* Parameter_size depends on runtime parameters */
/* IndexSignature_size depends on runtime parameters */
