...
class ValidateCodeArgs(_message.Message):
    __slots__ = ("datafile", "data", "file", "code", "schema", "attribute_name", "format", "external_pkgs")
...
class IndexSignature(_message.Message):
    __slots__ = ("key_name", "key", "val", "any_other")
